...
export class ReactCustomMain {
  ...
  static async provider([react, envs]: [ReactMain, EnvsMain]) {
    ...
    const ReactCustomEnv = react.compose([
      /**
    ...
    envs.registerEnv(ReactCustomEnv);
    return new ReactCustomMain();
  }
}

ReactCustomAspect.addRuntime(ReactCustomMain);
